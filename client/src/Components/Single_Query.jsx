  ...
  return (
    <div id="single_query_container">
      ...
      <div id="single_queries_container_data">
        ...
        asperiores, corporis vitae aspernatur accusantium velit fugiat? Quia
        natus reiciendis vitae minus delectus repudiandae earum laboriosam, iste
        molestias placeat? Molestias mollitia maiores, sed exercitationem veniam
        aut error voluptatibus iusto, vero tenetur quia! Blanditiis illo laborum
        quod doloremque, suscipit eligendi. Inventore dignissimos ullam rerum
        ...
        beatae perferendis architecto eligendi minus cupiditate hic minima magni
        et explicabo facilis pariatur iste necessitatibus veniam vero
        ...
        aperiam minus saepe quibusdam praesentium incidunt fuga? Cupiditate rem
        nam ratione sunt quos provident officiis excepturi ad hic, eius,
        ...
        Officia mollitia, aliquam repellendus, adipisci odit, doloribus
      </div>
      <div id="single_query_container_headerRight">
