...
console.log("error in fetching ",err)
  ...
  return (
    <div className='for_footer_color' id="quickUpdates_container">
      <div id="quickUpdates_container_title">
      ...
      <div id="quickUpdates_container_main">
        ...
        <form id="quickUpdates_container_main_left_query_form" onSubmit={formSubmit}>

          <div id="quickUpdates_container_main_left_country">
            <div id="quickUpdates_container_main_left_country_give">Enter country name</div>
            <input name="country_name" type="text" placeholder="enter country name"></input>
          </div>
          <div id="quickUpdates_container_main_left_category">
          <div id="quickUpdates_container_main_left_category_give">Enter category </div>
            <input name="category_name" type="text" placeholder="enter category name"></input>
          </div>

          <div id="quickUpdates_container_main_left_query">
          <div id="quickUpdates_container_main_left_query_give">Enter query</div>
            <input name="specific_words_name" type="text" placeholder="enter specific words"></input>
          </div>

         

          <button id="quickUpdates_container_main_left_but" type="submit">Get News</button>
          </form>
