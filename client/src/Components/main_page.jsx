...
const coolEncapsulation = () => {
  ...
  return new Promise((resolve, reject) => {
    if (encap.current) {
      encap.current.style.transform = "translate(11.1rem, 9rem) scale(2.87,5.6)";
      ...
      setTimeout(() => {
        ...
        encap.current.style.transition = "transform 1s, border-radius 4s background-color 2s";
        encap.current.style.zIndex = "2";
        encap.current.style.position = "relative";
...
const coolResponsibility=()=>{
  ...
  return new Promise((resolve , reject)=>{
  if(respo.current){
 respo.current.style.transform="translate(-10.1rem, 9rem) scale(2.87,5.6) ";
...
const coolFreedom=()=>{
  if(freed.current){
    freed.current.style.transform="translate(1rem, -8.6rem) scale(2.87,5.6) ";
  ...
  return (
    <div className="for_footer_color" id="main_page_container">
       <div id="main_page_container_leftPart">
        ...
        Where Anonymity Meets <br/>Elevation,<br/> Accountability Leads the Way
        </div>
       </div>
      ...
      <div id="main_page_container_rightPart_firstEllipse" ref={encap}><div id="main_page_container_rightPart_firstEllipse_inner" ref={encap_inner}>Anonymity</div></div>
      <div  id="main_page_container_rightPart_secondEllipse" ref={respo}><div id="main_page_container_rightPart_secondEllipse_inner" ref={respo_inner}>Elevation</div></div>
      <div  id="main_page_container_rightPart_thirdEllipse" ref={freed}><div  id="main_page_container_rightPart_thirdEllipse_inner" ref={freed_inner}>Accountability</div></div>
      
      <div id="main_page_container_rightPart_firstEllipse_line" ref={encap_line}></div>
      <div id="main_page_container_rightPart_secondEllipse_line" ref={respo_line}></div>

      <div id="main_page_container_rightPart_thirdEllipse_line"ref={freed_line}></div>
