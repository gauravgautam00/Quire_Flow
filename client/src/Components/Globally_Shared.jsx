...
<div id="publically_shared_container_title">
  Public Queries
</div>
<div id="publically_shared_container_expandMore">
  Expand
  <span id="publically_shared_container_expandLink"class="material-symbols-outlined">
pan_zoom
</span>
</div>
...
<div id="publically_shared_container_left_selectOrganisation_expand">

</div>
<div id="publically_shared_container_left_selectDepartment">
  Select Department
</div>
<div id="publically_shared_container_left_selectDepartment_expand">

</div>
<input id="publically_shared_container_left_specific"  type="text" placeholder="Search for specific string to search for"/>
